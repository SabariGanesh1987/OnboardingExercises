...
public class CostOfallElectronicProductsGreaterThan1000 extends ProductList {
		...
		ICalculateCostofProducts calculateCostofallProducts = new ICalculateCostofProducts() {
			...
			public double calculate(List<Product> prodList) {
				...
				return listOfProducts.stream()
						.filter(x -> x.getProdCategory().equalsIgnoreCase("electronics")&&x.getProdPrice()>1000.00)
